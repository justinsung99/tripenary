...
// Triangle 2
    ...
    var colorcyan: FloatArray = myColor.cyan()
    var colorblue: FloatArray = myColor.blue()
    var colorred: FloatArray = myColor.red()
    var colorgray: FloatArray = myColor.gray()
    var colorgreen: FloatArray = myColor.green()
    var coloryellow: FloatArray = myColor.yellow()
    //vertex shader code
    ...
    var fShaderStr = ("#version 300 es		 			          	\n"
            ...
            + "}                                            \n")
    var TAG = "Pyramid"
    fun draw(mvpMatrix: FloatArray?) { // Use the program object
...
//constructor
    init { //first setup the mVertices correctly.
